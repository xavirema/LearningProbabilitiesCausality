...
\begin{columns}[b]
 ...
 \centering
  \includegraphics[width=\textwidth]{fig/IV-Pca/ppca_generation_1.pdf}\\ $\bs{z}$
 \end{column}\hfill
 \begin{column}{0.22\textwidth}
 \centering
  \includegraphics[width=\textwidth]{fig/IV-Pca/ppca_generation_2.pdf}\\ $\bs{A}\bs{z}$
 \end{column}\hfill
  \begin{column}{0.22\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig/IV-Pca/ppca_generation_3.pdf}\\ $\bs{A}\bs{z}+\bs{b}$
 \end{column}\hfill
  \begin{column}{0.22\textwidth}
  \centering
  \includegraphics[width=\textwidth]{fig/IV-Pca/ppca_generation_4.pdf}\\ $\bs{A}\bs{z}+\bs{b}+\bs{\epsilon}$
 \end{column}
