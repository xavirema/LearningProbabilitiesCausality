...
\begin{figure}[H]
\centering
\includegraphics[height=4.5cm]{fig/I-Introduction/clustering-3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=4.4cm]{fig/I-Introduction/ppca_cloud_axes.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=4.4cm]{fig/I-Introduction/hmm.pdf}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{fig/I-Introduction/mv-gaussian-standard.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{fig/I-Introduction/mv-gaussian-scale.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.7\textwidth]{fig/I-Introduction/mv-gaussian-full.png}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.05\textwidth]{fig/I-Introduction/simple-model.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=.15\textwidth]{fig/I-Introduction/full-xyz.pdf}\hspace{1cm}
\includegraphics[width=.15\textwidth]{fig/I-Introduction/twokids-xyz.pdf}\hspace{1cm}
\includegraphics[width=.15\textwidth]{fig/I-Introduction/twoparents-xyz.pdf}\hspace{1cm}
\includegraphics[width=.15\textwidth]{fig/I-Introduction/cascaded-xyz.pdf}
...
\begin{center}
\includegraphics[width=0.4\textwidth]{fig/I-Introduction/huge-muvar.pdf}
\end{center}
Is $P \indep V \;|\; T$ ? How would you do it ? Is the previous strategy scalable ? Let us recall the 3-variable models:

\begin{figure}[H]
\centering
\includegraphics[width=0.15\textwidth]{fig/I-Introduction/twokids-abc-color.pdf}\hspace{1cm}\includegraphics[width=0.15\textwidth]{fig/I-Introduction/cascaded-abc-color.pdf}\hspace{2cm}\includegraphics[width=0.15\textwidth]{fig/I-Introduction/twoparents-abc-color.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.25\textwidth]{fig/II-GraphicalModels/blockedpaths.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.3\textwidth,valign=t]{fig/II-GraphicalModels/temporal-simple.pdf}\hspace{5mm}\includegraphics[width=0.3\textwidth,valign=t]{fig/II-GraphicalModels/temporal-hmm.pdf}\hspace{5mm}\includegraphics[width=0.3\textwidth,valign=t]{fig/II-GraphicalModels/temporal2layer.pdf}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.3\textwidth]{fig/II-GraphicalModels/temporal-hmm.pdf}\hfill
 \includegraphics[width=0.3\textwidth]{fig/II-GraphicalModels/temporal-omm.pdf}\hfill
 \includegraphics[width=0.3\textwidth]{fig/II-GraphicalModels/temporal-ohmm.pdf}
\end{figure}
}\vspace{3mm}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{fig/II-GraphicalModels/D-separation.pdf}
\end{figure}}\vspace{3mm}
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.2\textwidth]{fig/II-GraphicalModels/D-separation-KBK.pdf}\hfill
 \includegraphics[width=0.2\textwidth]{fig/II-GraphicalModels/D-separation-LBL.pdf}\hfill
 \includegraphics[width=0.2\textwidth]{fig/II-GraphicalModels/D-separation-CBC.pdf}\hfill
 \includegraphics[width=0.2\textwidth]{fig/II-GraphicalModels/D-separation-EBE.pdf}
\end{figure}
