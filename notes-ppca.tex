...
\begin{figure}[H]
\centering\hfill
\includegraphics[width=0.22\textwidth]{fig/IV-Pca/ppca_generation_1.pdf}\hfill
\includegraphics[width=0.22\textwidth]{fig/IV-Pca/ppca_generation_2.pdf}\hfill
\includegraphics[width=0.22\textwidth]{fig/IV-Pca/ppca_generation_3.pdf}\hfill
\includegraphics[width=0.22\textwidth]{fig/IV-Pca/ppca_generation_4.pdf}\hfill
